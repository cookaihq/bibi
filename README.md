...
- **文本处理**：内置润色、Prompt优化、翻译的Prompt模版，可自定义添加任意处理模版（比如改人设、改语气、小语种翻译等等）；
...
![Xnip2026-03-30_21-01-47](https://github.com/user-attachments/assets/13ea4119-67af-4836-9c5f-9c7ee059fff3)
